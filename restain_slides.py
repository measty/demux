...
for slide in slides[:5]:
    ...
    try:
        ...
        continue
    if not (slide.parent / (slide.stem + "_restained7_HE.tiff")).exists():
        restainer.save_restained_WSI(slide.parent / (slide.stem + "_restained7.tiff"), stains=stains, lum_norm=False)
