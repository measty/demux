...
tile_path = Path(r"/media/u2071810/Data1/Multiplexstaining/Asmaa_Multiplex_Staining/tiles_pix2pix5")
patch_size = 256
n_tiles = 4000
...
def from_restained():
    filter = "*restained_hy_HE.tiff"
    he_slides = sorted(list(slide_path.glob(filter)))
    filter = "*restained_hy_HD.tiff"
